        ...
        <div class="text-center mt-10 px-5">
            <div class="my-5">
                ...
                <div align="center" class="my-10">
                    ...
                    <input id="search" name="search" type="text" required class="appearance-none rounded-none relative block w-full md:w-64 px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="First Name" />
                    </div>
                </div>
            </div>
            ...
            <div class="w-32">
                ...
                <a class="bg-green-300 shadow font-medium px-3 py-1 rounded-full" href="#">Details</a>
            </div>
            <div class="w-32">
