...
<body>
    ...
    <!-- <nav class="navbar">
        <div class="navbar__container">
            <a href="home.html" id="navbar__logo"><i class="fas fa-praying-hands"></i> SAHAYOG</a>
            ...
            <ul class="navbar__menu">
                <li class="navbar__item"><a href="home.html" class="navbar__links">Home</a></li>
                <li class="navbar__item"><a href="list.html" class="navbar__links">List</a></li>
                <li class="navbar__item"><a href="report.html" class="navbar__links">Report</a> </li>
                <li class="navbar__btn"><a href="register.html" class="button">Sign Up</a> </li>
            </ul>
        </div>
    </nav> -->
    ...
    <div class="report">
        ...
        <div class="mt-10 px-5">
            <form action="register_action.php" method="POST">
                <div>
                    <label class='topic'>Report Details </label>
                    <br><br>
                </div>
                <div>
                    <label class='font-semibold' for="image">Upload Image</label>
                ...
                <div class="mt-5">
                    <div class="flex flex-col gap-y-2">
                        ...
                        <div class="flex flex-wrap gap-3">
                            <!-- Lost on -->
                            <div align="start" class="w-full md:w-64">
                                <label class='font-semibold' for="lost_on">Lost on</label>
                            ...
                            <!-- Lost from -->
                            <div align="start" class="w-full md:w-64">
                                <label class='font-semibold' for="lost_from">Lost from</label>
                        ...
                        <!-- Relation -->
                        <div align="start" class="w-full md:w-64">
                            <label class='font-semibold' for="relation">Relation</label>
                        ...
                        <div class="w-full">
                            <label class='font-semibold' for="description">Other Details</label>
                ...
                <div>
                    <input id='submit' type="submit" name="btn_register" class="my-5 rounded-md py-2 px-5 bg-blue-200 hover:bg-blue-400" />
                </div>
            </form>

        </div>
        <div class="main__img--container">
            <img src="Images/people.jpg" alt="" id="main__img">
        </div>
    </div>
